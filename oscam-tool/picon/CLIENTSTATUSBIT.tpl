		<TR class="##CLIENTTYPE##">
			...
			<TD class="statuscol13"><IMG CLASS="clientpiconstatus" SRC="image?i=IC_##CLIENTCAID##_##CLIENTSRVID##" ALT="##CLIENTSRVPROVIDER####CLIENTSRVNAME##" TITLE="##CLIENTSRVPROVIDER####CLIENTSRVNAME##"></TD>
